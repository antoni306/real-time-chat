...
export class ConversationService {
    ...
    async create(createConversationDto:CreateConversationDto,creator:string):Promise<Conversation> {
        ...
        if(createConversationDto.type === ConversationType.DIRECT ) {
            ...
            const existsConversation = await this
            .conversationRepo
            ...
            if(existsConversation){
                throw new ConflictException('DIRECT conversation for those participants already exists')
            }
        }
        ...
        const conversation = this.conversationRepo.create({type:createConversationDto.type,name:createConversationDto.name ,participants:participants})
